...
public class MvcConfigurer implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		String[] directoryNames = new String[] { "user-photos", "category-images", "brand-logo-images", "product-images" };
		boolean[] parentDirectoryOrCurrentDirectory = new boolean[] { false, true, true, true };
