...
public class MvcConfigurer implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		String[] directoryNames = new String[] { "category-images", "brand-logo-images", "product-images", "site-logo" };
		boolean[] parentDirectoryOrCurrentDirectory = new boolean[] { true, true, true, true };
